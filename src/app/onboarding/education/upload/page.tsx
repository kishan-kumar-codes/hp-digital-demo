      ...
      Childrens={
        <div className="px-[43px] flex items-center w-full flex-col relative ">
          ...
          <div
            ...
            <button
              className="ml-[7px] text-[16px] md:text-xl font-bold cursor-pointer text-white py-[10px] w-[183px] text-center  bg-palatinatePurple rounded-xl lg:rounded-2xl lg:text-[36px] lg:px-10 lg:py-4 lg:w-[280px]"
